...
import com.example.smartcart.databinding.ItemCartBinding;
import com.example.smartcart.databinding.QuantityDailogBinding;
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                QuantityDailogBinding quantityDialogBinding = QuantityDailogBinding.inflate(LayoutInflater.from(context));
